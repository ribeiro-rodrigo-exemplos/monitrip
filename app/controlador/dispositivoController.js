...
class DispositivoController {
    constructor(dispositivoService, dispositivoRepository, ssoService, logger) {
    ...
    cadastrarPelaApi(req, res, next) {
        ...
        this._logger.info(`DispositivoController - cadastrarPelaApi  - credenciais: ${credenciais.usuario} - imei: ${credenciais.imei}`);
    ...
    cadastrarPelaWeb(req, res, next) {
        ...
        this._logger.info(`DispositivoController - cadastrarPelaWeb  - idCliente: ${req.idCliente}`);
    ...
    obter(req, res, next) {
        this._logger.info(`DispositivoController - obter  - idCliente: ${req.idCliente} - id: ${req.params.id}`);
    ...
    editar(req, res, next) {
        ...
        this._logger.info(`DispositivoController - editar  - idCliente: ${req.idCliente} - id: ${req.params.id}`);
    ...
    alterarEstado(req, res, next) {
        ...
        this._logger.info(`DispositivoController - alterarEstado  - idCliente: ${req.idCliente} - id: ${req.params.id} - ativo: ${ativo}`);
    ...
    listar(req, res) {
        this._logger.info(`DispositivoController - listar  - idCliente: ${req.idCliente} - ativo: ${req.query.ativo} - imei: ${req.query.imei} - descricao: ${req.query.descricao}`);
...
safira.define(DispositivoController);
